...
#+begin_src snippet :tangle ~/.config/emacs/snippets/text-mode/verbos-consecutivos
  ...
  # --
  Evite el uso de verbos consecutivos. Verhttps://baracunatana.github.io/comunicacionEscrita/comunicacionEscrita.html#/slide-verbos-seguidos para más información.
#+end_src
***** TODO =dired=
