...
Para que la base datos (la que indica qué ya está marcado como leído y qué no) se pueda sincronizar entre equipos, hay que ubicarla en una ruta sincronizada con pCloud.
