...
Host imap.gmail.com
User <<pregunta("Dirección de corre gmail: ")>>
...
Port 993
User <<pregunta("Dirección de correo PUJ: ")>>
...
#+begin_src sh :tangle ./inicio-correo.sh :noweb no-export
  ...
  # mbsync -c ~/.mbsyncrc -a
  # mu init --maildir=~/mbsync --my-address=<<pregunta("Correo PUJ: ")>> --my-address=<<pregunta("Corre gmail: ")>>
  # mu index
#+end_src
